...
class load():
    ...
    def load_data(self,flag='indian'):
        if flag == 'indian':
            Ind_pines_dict = scio.loadmat('/content/drive/MyDrive/BTP2/ASSMN/datasets/Indian_pines.mat')
            Ind_pines_gt_dict = scio.loadmat('/content/drive/MyDrive/BTP2/ASSMN/datasets/Indian_pines_gt.mat')
